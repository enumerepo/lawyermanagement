					...
					<div class="row">
						<div class="col-md-12">
							<nav class="navbar navbar-expand-lg ">
								<a class="navbar-brand cus-a" href="#">Lawyer Booking System</a>
														...
														<div class="form-row">
															...
															<div class="form-group col-md-3">
																...
																<select id="city" name="city" class="form-control">
																	...
																	<option value="Kirinyaga" <?php if ($row['city']=='Kirinyaga'){echo "selected";}?>>Kirinyaga</option>
																	<option value="Embu" <?php if ($row['city']=='Embu'){echo "selected";}?>>Embu</option>
																	<option value="Mombasa" <?php if ($row['city']=='Mombasa'){echo "selected";}?>>Mombasa</option>
																	<option value="Nyeri" <?php if ($row['city']=='Nyeri'){echo "selected";}?>>Nyeri</option>
																	<option value="Lamu" <?php if ($row['city']=='Lamu'){echo "selected";}?>>Lamu</option>
																	<option value="Eldoret" <?php if ($row['city']=='Eldoret'){echo "selected";}?>></option>
																</select>
															</div>
															<div class="form-group col-md-3">
